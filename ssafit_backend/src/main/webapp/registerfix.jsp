...
<body>
  ...
  <div style="display: flex; justify-content: center;">
    <div class="form-floating mb-3" style="width: 95%;">
      <input type="text" class="form-control" id="floatingInput" placeholder="수정할 제목을 입력하세요">
  ...
  <div style="display: flex; justify-content: center;">
    <div class="form-floating"  style="width: 95%;">
      ...
      type="text" class="form-control" id="floatingPassword" placeholder="수정할 내용을 입력하세요">
      <label for="floatingPassword">수정할 내용을 입력하세요</label>
    </div>
  </div>
  
  <div style="padding-top: 20px; padding-left: 20px;"> 
    <button type="button" class="btn btn-outline-primary" id="registbt">등록</button>
    <button type="button" class="btn btn-outline-danger" id="cancelbt">취소</button>
  </div>
