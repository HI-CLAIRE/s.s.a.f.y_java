...
______ vin = "KMHXX00XXXX000000";
______ modelName = "소나타";
______ color = "Blue";
______ mileage = 120000;

______ info = `내 자동차는 ______이고, 색상은 ______입니다. 오늘까지 ______ 주행했습니다.`;
...
console.log(text.______("ssafy"));
// 안녕으로 내용이 시작하는지를 확인한다.
console.log(text.______("안녕"));
// .으로 내용이 끝나는지 확인한다.
...
const found = ages.______((age) => age >= 20);
